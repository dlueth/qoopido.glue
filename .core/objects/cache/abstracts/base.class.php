<?php
namespace Glue\Objects\Cache\Abstracts;
	...
	final public function get() {
		try {
			...
			if(($data = $this->_get()) !== false) {
				...
				// check reload
				if($data['status']['reload'] === true && \Glue\Components\Factory::getInstance()->exists('\Glue\Components\Client') === true && \Glue\Components\Client::getInstance()->get('reload') === true) {
					$return = false;
				}
